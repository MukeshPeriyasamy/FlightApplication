...
public class Ticket {
	...
	@Id
	@SequenceGenerator(name="mysequence", initialValue=87450)
	...
	public Ticket(long ticketId, String airlineName, String flightName, String startPlace, String endPlace,
			...
			float totalCost, String status,int scheduleId) {
		this(airlineName, flightName, startPlace, endPlace, startTime, endTime, userName, email, journeyDate, totalSeats, totalCost, status, scheduleId);
		this.ticketId = ticketId;
	}
